      ...
      max-w-lg p-8">
        ...
        <div> 
          {loading ? (
            ...
            <p className="text-gray-600"> No tasks available. Add a
            new task!</p>
          ) : (
                  ...
                  {editingTodo === todo.todo_id ? (
                    <div className="flex items-center gap-x-3">
                      <input 
                        ...
                        type="text" 
                        value={editedText} 
                        onChange={(e) => setEditedText(e.target.
                        value)} 
                      />
                      <div>
                        <button 
                    ...
                    items-center">
                      <div className="flex items-center gap-x-4">
                        <button 
                          ...
                          className={`flex-shrink-0 h-6 w-6 border-2 
                        ...
                        >
                          {todo.completed && <MdOutlineDone size=
                          {16} />}
                        </button>
